...
@section('content')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header pb-0">
                <p class="tx-40 tx-primary-800 mb-4">مضادات الاستطبابات</p>
            </div>
            <div class="col-sm-4 col-md-4">
                <a class="btn ripple btn-primary tx-16" data-target="#modalCreate" data-toggle="modal" href="">إضافة مضاد</a>
            </div>
            <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">أصافة مضاد استطباب</h6>
                ...
                <div class="modal-body">
                    <form action="{{ route('index') }}" method="get">
                        <div class="form-group">
                            <label for="exampleInputEmail1">اسم المضاد</label>
                            <div class="row">
                                <div class="col-6">
    ...
    <div class="modal" id="modalUpdate">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">تعديل مضاد استطباب</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal" id="modalDelete">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف مضاد</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <p class="font-weight-bold">هل أنت متأكد من عملية حذف هذا المضاد</p>
                </div>
                <div class="modal-footer">
