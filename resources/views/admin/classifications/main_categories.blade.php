...
@section('content')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header pb-0">
                <p class="tx-26 tx-gray-500 mb-2">الأقسام الرئيسية</p>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">أصافة قسم رئيسي</h6>
                ...
                <div class="modal-body">
                    <form action="{{ route('index') }}" method="get">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="exampleInputEmail1">صورة القسم الرئيسي</label>
                            </div>
                            <div class="col-sm-16">
    ...
    <div class="modal" id="modalUpdate">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">تعديل قسم رئيسي</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('index') }}" method="get">
                        <div class="">
                            <div class="form-group">
                                <label for="category_name">اسم القسم الرئيسي</label>
    ...
    <div class="modal" id="modalDelete">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف قسم رئيسي</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <p class="font-weight-bold">هل أنت متأكد من عملية حذف هذا القسم الرئيسي</p>
                </div>
                <div class="modal-footer">
