...
@section('content')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header pb-0">
                <p class="tx-26 tx-gray-500 mb-2">الأقسام الفرعية</p>
            </div>
                    ...
                    <form action="{{ route('index') }}" method="get">
                        ...
                        <div class="col-9">
                            ...
                            <select id="main_category_select" class="form-control select2-results">
                                ...
                                <option value="Firefox" class="si-options">
                                    القسم الأول
                                </option>
                                <option value="Chrome">
                                    القسم الثاني
    ...
    <div class="modal" id="modalUpdate">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">تعديل قسم فرعي</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal" id="modalDelete">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف قسم فرعي</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <p class="font-weight-bold">هل أنت متأكد من عملية حذف هذا القسم الفرعية</p>
                </div>
                <div class="modal-footer">
