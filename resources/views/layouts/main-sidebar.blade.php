...
{{--            <li class="side-item side-item-category  tx-20">الإدارة</li>--}}
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label  tx-18 font-weight-bold">إدارة عمليات التسجيل</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.insurance_companies5') }}">طلبات الصيدليات</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.insurance_companies4') }}">طلبات المزودين</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label  tx-18 font-weight-bold">إدارة الأدوية</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item  tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.main_categories') }}">الأدوية</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold " href="{{ url('/' . $page='admin.classifications.pharmaceutical_companies232') }}">طلبات إضافة أدوبة</a></li>
                </ul>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label  tx-18 font-weight-bold">إدارة تصنيفات الأدوية</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item tx-16 font-weight-bold " href="{{ url('/' . $page='admin.classifications.pharmaceutical_companies') }}">شركات الأدوبة</a></li>
                    <li><a class="slide-item  tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.storage_methods') }}">طرق التخزين</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold " href="{{ url('/' . $page='admin.classifications.dosage_forms') }}">الأشكال الصيدلانية</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.scientific_materials') }}">المواد العلمية</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.indications') }}">الاستطبابات</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.contraindications') }}">مضادات الاستطبابات</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.side_effects') }}">التأثيرات الجانبية</a></li>
                    <li><a class="slide-item tx-16 font-weight-bold" href="{{ url('/' . $page='admin.classifications.therapeutic_effects') }}">التأثيرات العلاجية</a></li>
                </ul>
